...
<html>
	...
	<body class="left-sidebar">
		<div id="page-wrapper">
			...
			<!-- Header -->
				<header id="header">
					<h1 id="logo"><a href="../index.blade.php">Twenty <span>by HTML5 UP</span></a></h1>
					<nav id="nav">
						<ul>
							<li class="current"><a href="../index.blade.php">Welcome</a></li>
							<li class="submenu">
								<a href="#">Layouts</a>
								<ul>
		...
		<!-- Scripts -->
			...
			<script src="../../../public/assets/js/jquery.scrollgress.min.js"></script>
